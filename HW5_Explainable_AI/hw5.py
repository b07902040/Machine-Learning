...
img_indices = [57, 3207, 4707, 3784]
"""## Argument parsing"""

args = {
      'ckptpath': './model_end_best.pkl',
...
model.load_state_dict(torch.load('model_end_best.pkl'))
...
plt.savefig('{}/saliency_map.png'.format(sys.argv[2]))
...
images, labels = train_set.getbatch(img_indices)
filter_activations, filter_visualization = filter_explaination(images, model, cnnid=15, filterid=7, iteration=1000, lr=0.1)

# 畫出 filter visualization
plt.figure(figsize=(15, 8))
plt.imshow(normalize(filter_visualization.permute(1, 2, 0)))
plt.savefig('{}/filter_visualization1.png'.format(sys.argv[2]))
fig, axs = plt.subplots(2, len(img_indices), figsize=(15, 8))
for i, img in enumerate(images):
  axs[0][i].imshow(img.permute(1, 2, 0))
for i, img in enumerate(filter_activations):
  axs[1][i].imshow(normalize(img))
plt.savefig('{}/filter_activation1.png'.format(sys.argv[2]))
filter_activations, filter_visualization = filter_explaination(images, model, cnnid=15, filterid=16, iteration=1000, lr=0.1)

# 畫出 filter visualization
plt.figure(figsize=(15, 8))
plt.imshow(normalize(filter_visualization.permute(1, 2, 0)))
plt.savefig('{}/filter_visualization2.png'.format(sys.argv[2]))
fig, axs = plt.subplots(2, len(img_indices), figsize=(15, 8))
for i, img in enumerate(images):
  axs[0][i].imshow(img.permute(1, 2, 0))
for i, img in enumerate(filter_activations):
  axs[1][i].imshow(normalize(img))
plt.savefig('{}/filter_activation2.png'.format(sys.argv[2]))
filter_activations, filter_visualization = filter_explaination(images, model, cnnid=15, filterid=25, iteration=1000, lr=0.1)

# 畫出 filter visualization
plt.figure(figsize=(15, 8))
plt.imshow(normalize(filter_visualization.permute(1, 2, 0)))
plt.savefig('{}/filter_visualization3.png'.format(sys.argv[2]))
fig, axs = plt.subplots(2, len(img_indices), figsize=(15, 8))
for i, img in enumerate(images):
  axs[0][i].imshow(img.permute(1, 2, 0))
for i, img in enumerate(filter_activations):
  axs[1][i].imshow(normalize(img))
plt.savefig('{}/filter_activation3.png'.format(sys.argv[2]))
filter_activations, filter_visualization = filter_explaination(images, model, cnnid=15, filterid=36, iteration=1000, lr=0.1)

# 畫出 filter visualization
plt.figure(figsize=(15, 8))
plt.imshow(normalize(filter_visualization.permute(1, 2, 0)))
plt.savefig('{}/filter_visualization4.png'.format(sys.argv[2]))
fig, axs = plt.subplots(2, len(img_indices), figsize=(15, 8))
for i, img in enumerate(images):
  axs[0][i].imshow(img.permute(1, 2, 0))
for i, img in enumerate(filter_activations):
  axs[1][i].imshow(normalize(img))
plt.savefig('{}/filter_activation4.png'.format(sys.argv[2]))
filter_activations, filter_visualization = filter_explaination(images, model, cnnid=15, filterid=49, iteration=1000, lr=0.1)

# 畫出 filter visualization
plt.figure(figsize=(15, 8))
plt.imshow(normalize(filter_visualization.permute(1, 2, 0)))
plt.savefig('{}/filter_visualization5.png'.format(sys.argv[2]))
...
for i, img in enumerate(filter_activations):
  axs[1][i].imshow(normalize(img))
plt.savefig('{}/filter_activation5.png'.format(sys.argv[2]))
